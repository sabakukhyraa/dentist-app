  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`flex justify-between w-full ${isNew && "!justify-end"}`}
        >
          {!isNew && (
      ...
      <div
        className={`fixed flex items-center top-0 left-0 z-[99999] w-screen h-screen bg-black bg-opacity-60 ${
          !isModalOpen && "hidden"
        }`}
      >
        <PatientRegister setIsModalOpen={setIsModalOpen} />
      </div>
    </>
  );
}
